                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarEcommerce" aria-expanded="false" aria-controls="sidebarEcommerce" class="side-nav-link">
                                <i class="uil-store"></i>
                                <span> Depertmeant </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebarEcommerce">
                                <ul class="side-nav-second-level">
                                    <li>
                                            <a href="{{route('depertmeant-index')}}">Manage Depertmeant</a>
                                    </li>
                                    <li>
                        ...
                        <li class="side-nav-item">
                            <form method="POST" action="{{ route('logout') }}" id="logout-form">
                                @csrf
                                <button type="submit" class="side-nav-link d-flex align-items-center gap-2 px-3 py-2 rounded-3 transition-all w-100 border-0 bg-transparent text-start" style="cursor: pointer;">
