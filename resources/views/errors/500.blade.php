...
<head>
    ...
    <title>500 - Server Error • Hospital System</title>
...
<body>
    ...
    <div class="flex-grow-1 d-flex align-items-center justify-content-center py-5 px-3">
        <div class="med-card text-center">
            ...
            <!-- Big 500 with alert icon -->
            <div class="error-icon-wrapper mb-3">
                <span class="error-number">5</span>
                <i class="mdi mdi-alert-circle-outline" style="font-size: 3.5rem; color: #dc2626;"></i>
                <span class="error-number">0</span>
            </div>

            <!-- Heading -->
            <h5 class="med-heading mb-2">Server Error</h5>
            ...
            <p class="med-text mb-4">
                Something went wrong on our end. Our medical staff has been notified. 
