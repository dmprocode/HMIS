        ...
        <div>
            <div class="d-flex align-items-center gap-2 mb-2">
                <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3 py-2 fw-semibold"
                    ...
                    <i class="mdi mdi-shield-check"></i> HMIS
                </span>
            ...
            <p class="text-muted mb-0" style="font-size: 14px;">
                Muhtasari wa idara zote za hospitali — Hospital Management Information System
            </p>
        </div>
            ...
            <div class="card dept-card shadow-sm h-100" style="--dept-color: #0891b2;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div class="dept-icon" style="background: #0891b215;">
                            <i class="mdi mdi-account-multiple-plus" style="color: #0891b2;"></i>
                        </div>
                        <span class="dept-code-badge" style="background: #0891b215; color: #0891b2;">PTS</span>
                    </div>

                    <div class="dept-name-en">Manage Patients</div>
                    <div class="dept-name-sw">Usimamizi wa Wagonjwa</div>

                    <p class="text-muted mb-3 mt-2" style="font-size: 13px;">
                        <i class="mdi mdi-information-outline"></i> Ongeza, hariri, au futa taarifa za wagonjwa
                    </p>
                    ...
                    <div class="d-flex justify-content-between border-top pt-3">
                        <div class="text-center flex-fill">
                            ...
                            <div class="dept-stat-label">Jumla</div>
                        </div>
                        <div class="text-center flex-fill">
                            <div class="dept-stat-number text-success">28</div>
                            <div class="dept-stat-label">Hai</div>
                        </div>
                        <div class="text-center flex-fill">
                            <div class="dept-stat-number text-warning">4</div>
                            <div class="dept-stat-label">Walazwa</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer py-2">
                    <div class="d-flex gap-2">
                        {{-- Add Patient --}}
                        <a href="{{route('patents.index')}}" class="btn btn-sm flex-fill fw-semibold"
                            style="background: #0891b2; color: #fff; font-size: 12px;">
                            <i class="mdi mdi-account-plus"></i> Add Patients
                        </a>
